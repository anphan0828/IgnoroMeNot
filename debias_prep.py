...
# Some filenames
FILE_ALTERNATE_ID_TO_ID_MAPPING = "data_for_ignoromenot/alt_to_id.graph"
# FILE_CAFA_ID_TO_UNIPROT_ID_MAP = "data_for_ignoromenot/CAFAIDTOUniprotIDMap.txt"
FILE_MFO_ONTOLOGY_GRAPH = "data_for_ignoromenot/mf.graph"
FILE_BPO_ONTOLOGY_GRAPH = "data_for_ignoromenot/bp.graph"
FILE_CCO_ONTOLOGY_GRAPH = "data_for_ignoromenot/cc.graph"
FILE_MFO_ONTOLOGY_ANCESTORS_GRAPH = "data_for_ignoromenot/mf_ancestors.map"
FILE_BPO_ONTOLOGY_ANCESTORS_GRAPH = "data_for_ignoromenot/bp_ancestors.map"
FILE_CCO_ONTOLOGY_ANCESTORS_GRAPH = "data_for_ignoromenot/cc_ancestors.map"
ROOT_BPO = 'GO:0008150'
ROOT_CCO = 'GO:0005575'
ROOT_MFO = 'GO:0003674'
...
def findAllAncestorsForAllNodesForOntology(ontology):
    graph = cp.load(open("data_for_ignoromenot/" + ontology + ".graph", "rb"))
...
def main():
    ...
    if os.path.isdir("data_for_ignoromenot") == False:
        os.makedirs("data_for_ignoromenot")
